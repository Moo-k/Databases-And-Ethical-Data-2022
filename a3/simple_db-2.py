...
class SimpleDatabase:
    ...
    def search_index(self, column_name,column_value):
        selected_rows = []
        for i in indexes:
    ...
    def select_rows(self, table_name, column_name, column_value):
        ...
        selected_rows = self.search_index(column_name,column_value) # call search function within engine
        if selected_rows: # if selected rows is not empty
